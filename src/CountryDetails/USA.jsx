      ...
      <div className="Country-And-Details-Section">
        ...
        <div className="Country-Paragraph-Section">
          <div className="country-section-image">
            <img src="https://img.freepik.com/free-photo/island-symbol-storm-architecture-manhattan_1206-67.jpg?uid=R183500011&ga=GA1.1.1860702175.1736869206&semt=ais_hybrid" alt="Canada Immigration" className='img-fluid mt-5' />
          </div>
